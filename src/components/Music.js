...
const Music = ({category,imageList}) => {
...
const handlePrevious =(index)=>{
  ...
  setCurrentIndex(isFirst ? imageList.length-1 : index-1)
}
    ...
    <div className= "h-[calc(100vh-50px)] font-Josefin bg-login bg-cover" >
       ...
       <h1 className="text-center p-4 text-4xl italic text-[#be9656]">{category}</h1>
        <div className="w-[600px] h-[400px] mx-auto relative">
            ...
            <img src={imageList[currentIndex]}className="w-[100%] h-[100%] rounded-xl object-cover z-10 shadow-xl shadow-zinc-700" alt=" " />
